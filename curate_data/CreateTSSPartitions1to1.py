...
DATAFRAME_CSV = '../rawdata/TSS/EveryEnsemblTranscript_pos_and_neg_TSS_1to1.csv'
...
# X pos seqs
X_TRAIN_SEQS_POS_FILE = '../data/TSS/seqs/X_train_TSSseqs_pos_1to1.txt'
X_VAL_SEQS_POS_FILE = '../data/TSS/seqs/X_val_TSSseqs_pos_1to1.txt'
X_TEST_SEQS_POS_FILE = '../data/TSS/seqs/X_test_TSSseqs_pos_1to1.txt'
# X neg seqs
X_TRAIN_SEQS_NEG_FILE = '../data/TSS/seqs/X_train_TSSseqs_neg_1to1.txt'
X_VAL_SEQS_NEG_FILE = '../data/TSS/seqs/X_val_TSSseqs_neg_1to1.txt'
X_TEST_SEQS_NEG_FILE = '../data/TSS/seqs/X_test_TSSseqs_neg_1to1.txt'

# Processed X (as onehot) and y
X_TRAIN_FILE = '../data/TSS/onehot_serialized/X_train_TSS_1to1.pkl'
X_VAL_FILE = '../data/TSS/onehot_serialized/X_val_TSS_1to1.pkl'
X_TEST_FILE = '../data/TSS/onehot_serialized/X_test_TSS_1to1.pkl'

Y_TRAIN_FILE = '../data/TSS/onehot_serialized/y_train_TSS_1to1.pkl'
Y_VAL_FILE = '../data/TSS/onehot_serialized/y_val_TSS_1to1.pkl'
Y_TEST_FILE = '../data/TSS/onehot_serialized/y_test_TSS_1to1.pkl'
