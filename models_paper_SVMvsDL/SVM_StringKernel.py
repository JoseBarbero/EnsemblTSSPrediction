...
X_train_seqs_pos = pickle.load(X_train_seqs_pos_file)[::10]
X_train_seqs_neg = pickle.load(X_train_seqs_neg_file)[::10]
#X_val_seqs_pos = pickle.load(X_val_seqs_pos_file)
#X_val_seqs_neg = pickle.load(X_val_seqs_neg_file)
X_test_seqs_pos = pickle.load(X_test_seqs_pos_file)[::10]
X_test_seqs_neg = pickle.load(X_test_seqs_neg_file)[::10]
